...
class GazeboModel(object):
    ...
    def update_robot_index(self, data, robot_name):
        ...
        return found
    """
        Nella funzione callback è possibile settare eventuali offset rispetto alla posizione del sdr del robot
        cambiando gli offset a riga 104 105 106
    """
    ...
    def get_model_pose(self, robot_name):
        ...
        try:
            ...
            #rospy.loginfo("pose_now è settata " )
            #rospy.loginfo("la posizione di " + str(robot_name) + ": " + "\n" + str(pose_now))
        except Exception as e:
            s = str(e)
...
def listener():
    ...
    gazebo_models_list = ['park1','park2']
    gz_model = GazeboModel(gazebo_models_list)

    rate = rospy.Rate(100)  # 10hz   con questi 2 comandi e l'arg a 100 compie l'operazione di lettura una sola volta
    rate.sleep()
